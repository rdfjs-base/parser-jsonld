var
  ...
  rdf = require('rdf-ext')(),
  testData = require('rdf-test-data')(rdf),
  testUtils = require('rdf-test-utils')(rdf);
  JsonLdParser = require('../').bind(null, rdf);
...
describe('JSON-LD parser', function () {
  ...
  describe('example data', function () {
    it('card.json should be parsed', function (done) {
      ...
      testUtils.p.readFile('support/card.json', __dirname)
        .then(function (card) {
    ...
    it('list.json should be parsed', function (done) {
      ...
      testUtils.p.readFile('support/list.json', __dirname)
        .then(function (list) {
